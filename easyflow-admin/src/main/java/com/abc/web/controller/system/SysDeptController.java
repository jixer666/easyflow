...
public class SysDeptController extends BaseController
{
    ...
    @ApiOperation("获取部门树型结构")
    @GetMapping("/tree")
    public ApiResult<DeptTreeVO> getTree(@RequestParam(value = "parentId", required = false) Long parentId) {

        return ApiResult.ok(deptService.getTreeByParentId(parentId));
    }
}
